...
Commercial \- Specifications for commercial building models 
...
$$Q_{\text{heat}_n}(t) = Q_{\text{heat}_{\text{cap}_n}}(t) \cdot 
\Bigg[
  k_{P_{\text{heat}}} \big(T_n(t) - T_{\text{heat}_n}(t)\big) 
  + k_{I_{\text{heat}}} \sum_{\tau=t_{\text{reset}}}^t T_n(\tau) \Delta t_\tau 
  + k_{D_{\text{heat}}} \frac{T_n(t) - T_n(t-\Delta t)}{\Delta t}  
\Bigg]$$
...
$$Q_{\text{cool}_n}(t) = Q_{\text{cool}_{\text{cap}_n}}(t) \cdot 
\Bigg[
  k_{P_{\text{cool}}} \big( T_n(t) - T_{\text{cool}_n}(t) \big) 
  + k_{I_{\text{cool}}} \sum_{\tau=t_{\text{reset}}}^t T_n(\tau) \Delta t_\tau 
  + k_{D_{\text{cool}}} \frac{T_n(t) - T_n(t-\Delta t)}{\Delta t}  
\Bigg]$$
