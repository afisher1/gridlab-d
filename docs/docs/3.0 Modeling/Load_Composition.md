...
TMY2 climate data [[1]](http://rredc.nrel.gov/solar/old_data/nsrdb/tmy2/) is used to determine the weather conditions for any particular month, day of week, and hour of day. In the TMY2 file, the following data is used 
...
[![](//images.shoutwiki.com/gridlab-d/thumb/2/2d/ELCAP_end-use_loadshape_1.PNG/300px-ELCAP_end-use_loadshape_1.PNG)](/wiki/File:ELCAP_end-use_loadshape_1.PNG)
